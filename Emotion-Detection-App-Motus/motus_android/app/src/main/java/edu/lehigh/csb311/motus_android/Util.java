...
public class Util {
    ...
    public static AmazonS3Client getS3Client(Context context) {
        if (sS3Client == null) {
            BasicAWSCredentials awsCreds = new BasicAWSCredentials("AKIAJM7TGXYSRZUJONWQ", "vg+ZEoSGLil4fyo39Q9ZKRoFtnv7cfaaANsW/qdc");

            sS3Client = new AmazonS3Client(awsCreds);
            sS3Client.setRegion(Region.getRegion(Regions.fromName("us-west-2")));
        }
        return sS3Client;
    }
     ...
     * @param dateStr String input
     * @return Date object represented by that string
     */
     ...
     * @param d1 start date
     * @param d2 end date
     * @return difference between d1 and d2 in days
     */
